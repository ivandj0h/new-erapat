...
<div class="container">
    <div class="toolbar my-5" style="margin-left: 2px;">
        <strong> Form Upload Notulen</strong>&nbsp; - &nbsp;<i><?= $rapat->sub_department_name ?></i>
    </div>
    ...
    <div class="row">
        <div class="cell-12 my-5">
            <form data-role="validator" action="<?= base_url('notulenaction') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    <label class="cell-sm-2">&nbsp;</label>
                    <div class="cell-sm-10">
                        <button type="submit" class="button secondary"><span class="mif-cloud-upload"></span> Upload Notulen</button>
