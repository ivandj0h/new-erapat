...
<div class="container">
    <div data-role="navview" class="navview navview-compact-md navview-expand-lg">
        <div class="toolbar my-4" style="left: 20px !important;">
            <strong>Tambah Data Sekretariat</strong>
        </div>
        ...
        <div class="navview-content d-flex h-500">
            <div class="grid">
                <div class="row">
                    <div class="cell">
                        <form data-role="validator" action="<?= base_url('storesekretariat') ?>" method="POST">
                            ...
                            <table class="table cell-border table-border cell-media-table" style="width: 630px;left: -260px;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input data-role="input" data-validate="required" type="text" name="sekretariat" placeholder="isikan Nama Sekretariat">
                                        </td>
                                    </tr>
                                    <tr>
