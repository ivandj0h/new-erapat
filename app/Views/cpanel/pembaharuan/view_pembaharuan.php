    ...
    <div data-role="navview" class="navview navview-compact-md navview-expand-lg compacted js-compact">
        <div class="navview-pane">
            ...
            <ul class="navview-menu">
                ...
                <li>
                    <a href="#" data-role="popover" data-popover-text="Cek Rapat Offline" data-popover-position="right" data-cls-popover="bg-white fg-cobalt drop-shadow pop-over-width" data-popover-hide="0">
